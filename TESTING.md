...
| -------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| As a first time user, I want to clearly see what the application is about so that I have a good understanding of what it is about.          | Yes                   |                                                                                                                                                                                                          |
...
| As a user, I want to see my name and gender inputs within the game so that the game feels more customised to me.                       | Partial implemetation | This feature has been partially implemented. Customisation of the pronouns based on the supplied gender data within the the game will be addressed at the nex development stage when building Chapter 3. |
