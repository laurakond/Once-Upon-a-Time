...
story_dict = {
    ...
    "game_instructions": ["\nAt the start of the game, you will be prompted\n",
                          ...
                          "you will be prompted to choose between two\n",
                          "options to guess the progression of the story.\n",
                          "Enter your preferred option and see if you win!\n\n"
                          "Enjoy, and good luck!\n\n"],
    "story_intro": ["...in a far away land, there lived Snow White with\n",
                    "her prince charming. After defeating the Evil Queen,\n",
                    "peace was brought to their Kingdom. Snow White and\n",
                    "Prince Charming were happily expecting an addition to\n",
                    "their family - a little baby called {user_name}.\n\n",
    ...
    "chapter1": ["They searched for solutions and ways to stop her.\n",
    ...
    "no_name": ["\nSnow did not want to owe Rupel anything. Disclosing the \n",
                ...
                "for life.\n\nYou were unsuccessful!"],
    "chapter2": ["On the day of the planned escape, a purple curse cloud \n",
