...
story_dict = {
    ...
    "rumpel": ["Snow decides to speak to Rumpel.\n",
    ...
    "secret_door": ["They run down the secret stairs a level below where \n",
    ...
    "lock_door": ["The soldier is behind the door trying to break in. \n",
    ...
    "wardrobe": ["The curse is released and the fairytale characters \n",
                 ...
                 "accomplishment.\n\n",
                 f"But hope is not lost, as {user["name"]} has managed \n",
