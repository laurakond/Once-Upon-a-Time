...
story_dict = {
    ...
    "game_instructions": ["\nWhen you start the game, you will need to enter \n",
                          ...
                          "Enjoy, and good luck!\n"],
    "story_intro": ["\nOnce upon a time in a far away land, there lived Snow\n",
    ...
    "chapter1": ["Chapter 1\n\n",
                 ...
                 "Rumours reached them that Rumpelstiltskin would, \n",
                 "be able to help. Yet, Snow was aware of his 'dealings'\n",
    ...
    "secret_door": ["\nThey run down the secret stairs a level below where \n",
                    "the wardrobe room is located. Snow and Charming are \n",
                    "noticed by a soldier who starts marching their way:\n\n",
    ...
    "wardrobe": ["\nThe curse is released and the fairytale characters \n",
                 ...
                 "accomplishment.\n\n",
                 "But hope is not lost, as {user_name} has managed \n",
